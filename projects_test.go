...
const (
	...
	SampleProjectsNames    = `{"data":[{"project_id":"proj_id1","name":"name1"},{"project_id":"proj_id2","name":"name2"}],"meta":{"total_count":2,"offset":0,"last_update":"2020-10-22T18:04:59.9235814Z"}}`
)
