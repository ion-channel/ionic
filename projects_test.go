...
func TestProjects(t *testing.T) {
	...
	g.Describe("Projects", func() {
		...
		g.It("should return names and versions for projects", func() {
			server.AddPath("/v1/project/getNamesAndVersions").
				SetMethods("POST").
				SetPayload([]byte(SampleNamesAndVersions)).
				SetStatus(http.StatusOK)

			resp, err := client.GetNamesAndVersions("someId", []string{"sometoken"}, "token")
			Expect(err).To(BeNil())
			Expect(len(resp)).To(Equal(4))
			Expect(resp[0].ID).To(Equal("d73559a2-7cc8-430f-85fc-7dd7dff71695"))
			Expect(resp[0].Name).To(Equal("bar"))
			Expect(resp[0].Version).To(Equal(""))
		})
	})
}
...
const (
	...
	SampleNamesAndVersions = `{"data":[{"project_id":"d73559a2-7cc8-430f-85fc-7dd7dff71695","name":"bar","version":""},{"project_id":"d73559a2-7cc8-430f-85fc-7dd7dff71695","name":"bar","version":"10.0.1"},{"project_id":"d73559a2-7cc8-430f-85fc-7dd7dff71695","name":"bar","version":"5.1"},{"project_id":"d73559a2-7cc8-430f-85fc-7dd7dff71695","name":"bar","version":"9.a0.0"}],"meta":{"total_count":4,"offset":0,"last_update":"2020-10-22T18:04:59.9235814Z"}}`
)
