...
func TestProjects(t *testing.T) {
	...
	g.Describe("Mttr", func() {
		...
		g.It("should return a mttr of a project", func() {
			...
			Expect(r.Mttr).To(Equal(int64(86400)))
...
const (
	...
	SampleGetMttr          = `{"data":{"mttr":86400, "unresolved_incident":false,"time_in_current_status":158112,"failed_mttr_incidents":1,"project_count":1,"data":[{"status":"pass","count":2,"first_created_at":"2020-08-01T22:54:34.543703Z"},{"status":"fail","count":1,"first_created_at":"2020-08-02T22:54:34.579672Z"},{"status":"pass","count":1,"first_created_at":"2020-08-03T22:54:34.608181Z"}]},"meta":{"total_count":1,"offset":0,"last_update":"2020-08-05T18:48:10.6778402Z"}}`
)
