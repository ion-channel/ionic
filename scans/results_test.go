...
const (
	...
	SampleValidScanResultsBuildsystems  = `{"type":"buildsystems","data":{"compilers":[{"name":"Go","version":"1.1.0"}],"docker_file":{"images":[{"name":"golang","version":"1.1.0"}],"dependencies":[{"name":"bash","version":""},{"name":"build-base","version":""},{"name":"curl","version":""}]}}}`
