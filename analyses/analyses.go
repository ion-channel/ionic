...
const (
	...
	// AnalysisDeleteTestAnalysesEndpoint is a string representation of the current endpoint for delete test analyses
	AnalysisDeleteTestAnalysesEndpoint = "/v1/animal/deleteTestAnalyses"
)
